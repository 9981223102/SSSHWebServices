...
<jsp:useBean id="probeResult" class="com.homedepot.ss.sh.probe.ProbeResult" />
<HTML>
    <HEAD>
        <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
        <!-- EDIT HERE: ADD YOUR APPLICATION NAME HERE -->
        <TITLE>Application Probe - <jsp:getProperty name="probeResult" property="applicationName" /></TITLE>
    </HEAD>
    <BODY>
         ...
         <TABLE width="90%" border="0" align="left">
             <TR>
		         ...
		         <TD align="left">
		             ...
		             <jsp:getProperty name="probeResult" property="applicationName" /></FONT>
		         </TD>
	         </TR>
	         <TR>
		         <TD align="right" width="200">
		         ...
		         <TD align="left">
		             <FONT size="+1" face="Arial, sans-serif">
		             <jsp:getProperty name="probeResult" property="system" /></FONT>
		         </TD>
	         </TR>
	         <TR>
		         <TD align="right" width="200">
		         ...
		         <TD align="left">
		             <FONT size="+1" face="Arial, sans-serif">
		             <jsp:getProperty name="probeResult" property="subSystem" /></FONT>
		         </TD>
	         </TR>
	         <TR>
		         <%  
